...
<h4 class="text-center bg-primary text-light py-1">Signup Data </h4>
...
while(rs.next()){
	...
	<td><%=pa %></td>
	<td>
	<a type="button" href="UpdateSignup.jsp?email=<%=e%>" class="btn btn-warning">Update</a>
	<a type="button" href="DeleteSignup.jsp?email=<%=e%>" class="btn btn-danger btn-sm">Delete</a>
	</td>
	</tr>
	<%
}}catch(Exception e){
