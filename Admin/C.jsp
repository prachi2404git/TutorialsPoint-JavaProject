...
while(rs.next()){
	...
	<td><%=desc %></td>
	<td>
	<a type="button" href="Update.jsp?id=<%=i%>" class="btn btn-warning">Update</a>
	<a type="button" href="Delete.jsp?id=<%=i%>" class="btn btn-danger btn-sm">Delete</a>
	</td>
	</tr>
	<%
}}catch(Exception e){
