...
while(rs.next()){
	...
	<td><%=desc %></td>
	<td>
	<a type="button" href="UpdateC.jsp?id=<%=i %>" class="btn btn-warning">Update</a>
	<a type="button" href="DeleteC.jsp?id=<%=i %>" class="btn btn-danger btn-sm">Delete</a>
	</td>
	</tr>
	<%
}}catch(Exception e){
