...
while(rs.next()){
	...
	<td><%=desc %></td>
	<td>
	<a type="button" href="UpdateJ1.jsp?id=<%=i %>" class="btn btn-warning">Update</a>
	<a type="button" href="DeleteJ1.jsp?id=<%=i %>" class="btn btn-danger btn-sm">Delete</a>
	</td>
	</tr>
	<%
}}catch(Exception e){
